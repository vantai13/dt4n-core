...
TrafficFlood và CongestionShift đã chuyển sang run_host_shell qua mnexec. Đã inject TrafficFlood h1→srv1 50 Mbps trong lúc Sync Agent hoạt động và thu 30 snapshot: logs/ml_injection_v2.jsonl; có qdisc drop, không ERROR/CRITICAL. 4 security live test chạy lại đều pass: results/report/ml_security_live.xml. Audit timestamp dùng UTC có timezone.
