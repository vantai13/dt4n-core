...
<table><tr><th>Run</th><th>Kênh sớm nhất</th><th>Onset sớm</th><th>Chứng nhân mạnh nhất</th><th>Onset chứng nhân</th><th>Recovery chứng nhân</th></tr>{timing}</table>
...
<img src="label_overlay.png"><p><a href="ml_dataset_split_manifest.json">Manifest đo</a> · <a href="ground_truth.json">Onset từng kênh và13gate</a> · <a href="../../docs/phase-5/06-dataset-card.md">Dataset card</a></p></html>'''
    (report/'phase56_results.html').write_text(text)
    print(report/'phase56_results.html')
