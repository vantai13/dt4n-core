...
def build(root: Path, use_rolling: bool):
    ...
    manifest = {
        ...
        'dead_features': s.meta['dead_features'],
        'n_dead_features': s.meta['n_dead_features'],
        'envelope': s.envelope,
        'envelope_feature_names': list(s.X_test_envelope.columns),
        'envelope_threshold': s.envelope_threshold,
        'n_envelope_only_columns': s.meta['n_envelope_only_columns'],
        'n_envelope_if_overlap': s.meta['n_envelope_if_overlap'],
        'envelope_fit_train_rows': s.meta['envelope_fit_train_rows'],
        'envelope_test_rows_with_missing': int(s.X_test_envelope.isna().any(axis=1).sum()),
